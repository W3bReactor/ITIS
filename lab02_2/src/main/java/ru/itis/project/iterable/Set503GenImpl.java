...
/*
    variant 1 - описываем внутренний класс - итератор, возвращаем его экземпляр (как в папке iterator)
    variant 2 - описываем анонимный класс - итератор, возвращаем его экземпляр
